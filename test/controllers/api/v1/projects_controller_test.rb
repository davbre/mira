...
class Api::V1::ProjectsControllerTest < ActionController::TestCase
  ...
  test "API's projects/ endpoint should return list of projects including newly created one" do
  ...
  test "API's projects/[id] endpoint should return newly created project" do
